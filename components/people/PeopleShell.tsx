  ...
  return (
    <div className="space-y-6">
      ...
      <div className="-mx-4 -mt-4 mb-6 md:-mx-6 md:-mt-6">
        <div className="relative overflow-hidden bg-gradient-to-br from-blue-50/70 via-emerald-50/40 to-[#F8FAFB] px-4 py-7 md:px-6">
          <div className="pointer-events-none absolute right-20 top-5 h-3 w-3 rounded-full bg-blue-300/40" />
